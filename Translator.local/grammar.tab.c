...
{
      -4,    -8,    -9,    -3,     4,    -4,    -9,    -9,    -9,    -9,
      -1,    -7,     2,     8,    -9,    -9,    10,    -2,    -9,     7,
       1,    -9,     9,    11,    -9,    -1,    12,    18,    -9,    -9,
       3,    14,    -7,    -9,    -9,    13,    -9,    15,    16,    17,
      -1,    -9,    19,     5,    22,    -9,    -9
};
...
{
       4,     9,     5,     6,     0,     9,     7,    14,    10,    11,
      14,    10,    11,    10,    11,    10,    11,     9,    16,     9,
      13,     3,     9,    14,    10,    14,    14,    11,    11,    14,
       8,     5,    32,    -1,    15,    40,    -1,    -1,    -1,    -1,
      -1,    -1,    -1,    -1,    23,    25
};
...
#line 64 "grammar.y" /* yacc.c:1646  */
    {
												...
												for (int i=0; i<(yyvsp[-1].string_array).used; i++) {
													printf("vals(%s, %s). ", (yyvsp[-4].string), (yyvsp[-1].string_array).array[i]);
												}
...
#line 81 "grammar.y" /* yacc.c:1646  */
    {
										insertArray(&(yyvsp[-6].string_array), (yyvsp[-5].string));
										
										for (int i=0; i<(yyvsp[-1].pairs_array).used; i++) {
											if ((yyvsp[-1].pairs_array).array[i].used>0) {
												// Standard case	
												for (int j=0; j<(yyvsp[-1].pairs_array).array[i].used; j++) {
													printf("causesOneOf(id%d, (%s,I))",identifier,(yyvsp[-1].pairs_array).array[i].array[j]);
													
													printf(":-\n");
													
													for (int k=0; k<(yyvsp[-6].string_array).used; k++) {
														printf("\tworld( (%s,I) )",(yyvsp[-6].string_array).array[k]);
														if (k<(yyvsp[-6].string_array).used-1)
															printf(",\n");
														else
															printf(".\n");
													}
											...
											else
											{
												...
												printf("causesOneOf(id%d,((F,V),I))",identifier);
												
												printf(":-\n");
												
												for (int k=0; k<(yyvsp[-6].string_array).used; k++) {
													printf("\tworld( (%s,I) ),\n",(yyvsp[-6].string_array).array[k]);
												}
...
#line 124 "grammar.y" /* yacc.c:1646  */
    {
										for (int i=0; i<(yyvsp[-1].pairs_array).used; i++) {
											...
											for (int j=0; j<(yyvsp[-1].pairs_array).array[i].used; j++) {
												printf("initiallyOneOf(id%d, %s).\n",identifier,(yyvsp[-1].pairs_array).array[i].array[j]);
											}
...
#line 139 "grammar.y" /* yacc.c:1646  */
    { (yyval.pairs_array)=(yyvsp[-2].pairs_array); insert2DArray(&(yyval.pairs_array), (yyvsp[0].string_array)); }
#line 1334 "grammar.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 141 "grammar.y" /* yacc.c:1646  */
    { init2DArray(&(yyval.pairs_array),1); insert2DArray(&(yyval.pairs_array), (yyvsp[0].string_array)); }
...
#line 145 "grammar.y" /* yacc.c:1646  */
    {
														...
														(yyval.string_array).probability = malloc(sizeof(char)*strlen((yyvsp[-1].string)));
														strcpy((yyval.string_array).probability,(yyvsp[-1].string));
													}
...
#line 168 "grammar.y" /* yacc.c:1646  */
    {
												...
												insertArray( &(yyval.string_array), (yyvsp[-1].string) );
											}
...
#line 175 "grammar.y" /* yacc.c:1646  */
    {
							(yyval.string) = (char *) malloc( sizeof(char) * (3+strlen((yyvsp[-2].string))+strlen((yyvsp[0].string))) );
							strcpy((yyval.string),"(");
